      ...
      <div class="row" style="width: 1200px; margin-top:-5em;">
        <div class="col-lg-3 col-sm-6">
          <div class="circle-tile">
            <a href="#">
              <div class="circle-tile-heading dark-blue"><i class="glyphicon glyphicon-barcode gi-1" style="padding-top: 10px;"></i></div>
            </a>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="circle-tile ">
            <a href="#">
              <div class="circle-tile-heading purple"><i class="glyphicon glyphicon-bookmark gi-1" style="padding-top: 10px;"></i></div>
            </a>
            <div class="circle-tile-content purple">
              <div class="circle-tile-description text-faded"> Clientes </div>
              <div class="circle-tile-number text-faded "><?php while ($ver = mysqli_fetch_row($ret_clientes)) : echo $ver[0];
                                                          endwhile; ?></div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="circle-tile ">
            <a href="#">
              <div class="circle-tile-heading green"><i class="glyphicon glyphicon-shopping-cart gi-1" style="padding-top: 10px;"></i></div>
            </a>
            <div class="circle-tile-content green">
              <div class="circle-tile-description text-faded"> Compras de Productos </div>
              <div class="circle-tile-number text-faded "><?php while ($ver = mysqli_fetch_row($ret_compras)) : echo 'GS. ' . number_format($ver[0], 0, ",", ".");
                                                          endwhile; ?></div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="circle-tile ">
            <a href="#">
              <div class="circle-tile-heading blue"><i class="glyphicon glyphicon-usd gi-1" style="padding-top: 10px;"></i></div>
            </a>
            <div class="circle-tile-content blue">
              <div class="circle-tile-description text-faded"> Ventas</div>
              <div class="circle-tile-number text-faded "><?php while ($ver = mysqli_fetch_row($ret_ventas)) : echo 'GS. ' . number_format($ver[0], 0, ",", ".");
                                                          endwhile; ?></div>
              <a class="circle-tile-footer" href="view_compras.php">Ver<i class=""></i></a>
            </div>
          </div>
